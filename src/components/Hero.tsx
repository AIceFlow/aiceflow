...
const Hero = () => {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-hero">
      ...
      {/* Animated tennis court inspired grid pattern */}
      <div className="absolute inset-0 opacity-5">
        <div className="h-full w-full animate-float" style={{
          backgroundImage: `
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute bottom-1/3 right-1/4 w-16 h-16 bg-primary/10 rounded-full animate-float" style={{animationDelay: '1s'}}></div>
        <div className="absolute top-1/2 right-1/3 w-8 h-8 bg-primary/15 rounded-full animate-float" style={{animationDelay: '2s'}}></div>
      </div>
